#!/usr/bin/env python3
"""
auto_fix_tests_v4.py
Scans test files, applies patches to fix known failing tests,
then runs the test suite and prints + saves a compact summary.
"""
...
def run_tests():
    ...
    # Save to report file
    report_path = Path("tests/test_run_report.txt")
    report_path.write_text(result.stdout)

    if result.returncode == 0:
        print("✅ All tests passed successfully!")
    else:
        print("❌ Some tests failed. See details in tests/test_run_report.txt")
