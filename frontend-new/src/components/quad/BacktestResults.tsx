      ...
      <CardContent className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-4 gap-2">
          <div className="bg-muted/10 border border-border rounded-lg p-2">
            ...
            <span className="text-base font-black tabular-nums text-foreground">{data.win_rate.toFixed(1)}%</span>
          </div>
          <div className="bg-muted/10 border border-border rounded-lg p-2">
            ...
            )}>{data.avg_return.toFixed(2)}%</span>
          </div>
          <div className="bg-muted/10 border border-border rounded-lg p-2">
          ...
          <div className="bg-muted/10 border border-border rounded-lg p-2">
            ...
            <span className="text-base font-black tabular-nums text-destructive">-{data.max_drawdown.toFixed(1)}%</span>
          </div>
        </div>

        {/* Equity Curve Chart */}
        <div className="h-48 pt-2 min-w-0">
           ...
           <div className="flex gap-1 overflow-x-auto pb-2 scrollbar-none">
              {data.trades.slice(-10).map((trade: any, idx: number) => (
                ...
                >
                  ...
                  )}>{trade.pnl_pct > 0 ? '+' : ''}{trade.pnl_pct.toFixed(1)}%</span>
