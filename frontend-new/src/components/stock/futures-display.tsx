...
export function FuturesDisplay({ data, symbol }: FuturesDisplayProps) {
    if (!data || data.length === 0) {
        return (
            <Card className="bg-card border-border">
                <CardHeader>
                    <CardTitle className="text-foreground">Futures Data</CardTitle>
                </CardHeader>
                <CardContent>
    ...
    return (
        <Card className="bg-card border-border">
            <CardHeader>
                <CardTitle className="text-foreground">Futures - {symbol}</CardTitle>
            </CardHeader>
            <CardContent>
                <div className="space-y-4">
                    ...
                    <div className="bg-muted/50 rounded-lg p-4 border border-border">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <div className="text-sm text-muted-foreground">Futures Price</div>
                    ...
                    {data.length > 1 && (
                        <div>
                            <div className="text-sm font-medium text-foreground mb-2">All Contracts</div>
                            <div className="space-y-2">
                                {data.map((contract, index) => (
                                    <div key={index} className="flex items-center justify-between text-sm p-2 bg-muted/20 rounded border border-border">
