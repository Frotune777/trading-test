...
import CalloutHistoryTimeline from '@/components/quad/CalloutHistoryTimeline';
...
import PillarLiveTrend from '@/components/quad/PillarLiveTrend';
  ...
  return (
    <div className="p-0 space-y-4 animate-in fade-in duration-700">
      ...
      {loading ? (
        ...
        <div className="space-y-4 max-w-7xl mx-auto animate-in fade-in duration-700">
          {/* Command Section */}
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-4">
            ...
            <div className="xl:col-span-4 space-y-4 min-w-0">
              <CalloutHistoryTimeline symbol={symbol} days={30} />
              <PillarLiveTrend latestAnalysis={reasoning} />
