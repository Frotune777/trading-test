...
import { Search, Filter, RefreshCcw, Activity, Download } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-8 space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={() => data?.decisions && downloadCSV(data.decisions, `decisions_${symbol}_${new Date().toISOString().split('T')[0]}.csv`)}
                        disabled={!data?.decisions || data.decisions.length === 0}
                        className="flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors font-bold text-xs uppercase tracking-widest disabled:opacity-50"
                        title="Export to CSV"
                    >
