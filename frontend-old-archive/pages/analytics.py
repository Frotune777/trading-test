...
from frontend.utils.data_loader import get_database, get_updater, load_stock_data, calculate_metrics
from frontend.components.metrics import render_metrics_row
from frontend.components.tables import render_period_summary, render_quarterly_results, render_peer_comparison
from frontend.components.charts import render_shareholding_chart
...
def analytics_page():
    ...
    with col1:
        ...
        default_index = 0
        default_index = 0
        if 'selected_symbol' in st.session_state and st.session_state.selected_symbol and st.session_state.selected_symbol in symbols:
